        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 20),
              BuildTextField(hintText: "Name", controller: nameController),
              const SizedBox(height: 10),
              BuildTextField(hintText: "University Roll No.", controller: rollController),
              const SizedBox(height: 10),
              ...
              const SizedBox(height: 10),
              BuildTextField(hintText: "Confirm Password", controller: confirmPasswordController),
